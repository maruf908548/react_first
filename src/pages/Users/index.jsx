...
export default function UsersPage() {
          ...
          <div className="flex justify-center items-end gap-[22px]">
            ...
            <div className="flex items-center mt-[13px] gap-3 flex-1">
              <Img
                ...
                alt="circleimage"
                className="h-[43px] w-[43px] rounded-[50%]"
              />
              <Text
                size="md"
                as="p"
                className="!text-blue_gray-800 tracking-[0.15px]"
              >
                {info?.getValue?.()}
              </Text>
            </div>
      ...
      tableColumnHelper.accessor("status", {
        ...
        header: (info) => (
          <Text
            size="s"
            as="p"
            className="pt-3 pb-[30px] sm:pb-5 tracking-[0.14px]"
          >
            Status
          </Text>
        ),
      ...
      tableColumnHelper.accessor("department", {
        ...
        header: (info) => (
          <Text
            size="s"
            as="p"
            className="pt-[13px] pb-[29px] sm:pb-5 tracking-[0.14px]"
          >
            Department
          </Text>
        ),
      ...
      tableColumnHelper.accessor("activity", {
        cell: (info) => (
          <div className="flex justify-between gap-5">
            ...
            <Img
              src="images/img_hover_settings.svg"
              alt="hoversettings"
  ...
  return (
    <>
      ...
      <div className="flex ">
        <Sidebar width="237px" className="bg-blue_gray-50 overflow-auto">
          {
            <Sidebar
              width="237px !important"
              className="flex flex-col h-screen ml-5 pb-8 pr-8 gap-6 top-0 sm:pb-5 sm:pr-5 bg-blue_gray-50 !sticky overflow-auto"
            >
              <Img
                src="images/img_logo.png"
                alt="logo_one"
                className="self-stretch md:h-auto object-cover"
              />
              <Menu
                menuItemStyles={{
                  button: {
              ...
              >
                <div className="flex flex-col self-stretch">
                  ...
                  <SubMenu
                    icon={
                      <Img
                        src="images/img_users_blue_gray_900.svg"
                        alt="users_four"
                        className="h-[24px] w-[24px]"
                      />
                    }
              ...
              <div className="flex flex-col items-center gap-[29px]">
                <div className="flex md:flex-row items-center w-[85%] md:w-full gap-60">
                  <div className="flex flex-col items-start gap-2 p-[13px]">
                    <Text
                      size="xl"
                      as="p"
                      className="ml-[17px] md:ml-0 !text-blue_gray-900 tracking-[0.15px] text-center"
                    >
                      12
                    </Text>
                    <Text
                      size="md"
                      as="p"
                      className="mb-3 ml-[25px] md:ml-0 !text-gray-400 tracking-[0.15px] text-center"
                    >
                      Peoples
                    </Text>
                  </div>
                  ...
                  <div className="flex flex-col items-start gap-2 p-3.5">
                    <Text
                      size="xl"
                      as="p"
                      className="ml-[33px] md:ml-0 !text-blue_gray-900 tracking-[0.15px] text-center"
                    >
                      5
                    </Text>
                    <Text
                      size="md"
                      as="p"
                      className="mb-[11px] ml-2 md:ml-0 !text-gray-400 tracking-[0.15px] text-center"
                    >
                      Departments
                    </Text>
                  </div>
                ...
                <div className="flex flex-col w-[94%] md:w-full gap-6">
                  <div className="flex md:flex-col justify-between gap-5">
                    ...
                    <div className="flex justify-center gap-2.5">
                      <Button
                        leftIcon={
                          <Img src="images/img_userplus.svg" alt="UserPlus" />
                        }
                  ...
                  <div className="flex justify-between items-start gap-5">
                    <div className="flex justify-center w-[29%] gap-6">
                      <SelectBox
                        ...
                        className="flex w-[100%] pl-3 pr-[35px] gap-px py-2 sm:pr-5 text-blue_gray-900 tracking-[0.10px] text-[15px] bg-gray-100 rounded-lg"
                      />
                      <SelectBox
                        indicator={
                          <Img
                        ...
                        options={dropDownOptions}
                        className="flex w-[100%] pl-3 pr-[5px] gap-px py-2 sm:pr-5 text-blue_gray-900 tracking-[0.10px] text-[15px] bg-gray-100 flex-1 rounded-lg"
                      />
                    </div>
                    <Button className="flex items-left justify-center h-[40px] w-[40px]">
                ...
                <div className="self-stretch h-[478px] relative">
                  <Text
                    size="s"
                    as="p"
                    className="right-[5%] top-[5%] m-auto !text-gray-600_01 tracking-[0.14px] absolute"
                  >
                    Активность
                  </Text>
